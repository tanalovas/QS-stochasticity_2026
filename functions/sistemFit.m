...
alpha1    = beta/(1+M/kin);
gamma     = beta/(1+M/kin)*(R1star/(katt+R1star)+R2star/(katt+R2star));
rho       = alpha1;
delta1    = beta*(R1star/(katt+R1star)+R3star/(katt+R3star));
delta2    = beta/(1+R3/kin)*1/(1+R1/kin)*R2star/(katt+R2star);
delta3    = beta/(1+R2/kin)*(R1star/(katt+R1star)+R3star/(katt+R3star));
